...
# Usage:
# csmit -m 20G -c 1 "./4_log2_ChIPinput_perbase.R H3K27me3_ChIP_SRR1509478 WT_H3K27me3_Rep1_ChIP_input"

args <- commandArgs(trailingOnly = TRUE)
ChIPname <- args[1]
inputname <- args[2]
outname <- paste0("log2_", ChIPname, "_input")
...
input <- read.table(paste0(inDir,
                           ...
                           "_norm_allchrs_coverage_coord_tab.bed"))
print(head(input))
ChIP_input_offset <- cbind(ChIP, ChIP$V4+1, input$V5+1)  
